...
namespace MonoGame.Framework.Content.Pipeline.Serialization.Compiler
{
    ...
    class EnvironmentMapEffectWriter : BuiltInContentWriter<EnvironmentMapMaterialContent>
    {
        ...
        {
            output.WriteExternalReference(
                value.Textures.ContainsKey(EnvironmentMapMaterialContent.TextureKey) ? value.Texture : null);
            
            output.WriteExternalReference(
                value.Textures.ContainsKey(EnvironmentMapMaterialContent.EnvironmentMapKey) ? value.EnvironmentMap : null);
