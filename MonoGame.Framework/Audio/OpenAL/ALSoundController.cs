...
{
    internal sealed class ALSoundController : IDisposable
    {
        ...
        public static ALSoundController Instance
        {
            ...
            {
                if (_closed)
                    throw new ObjectDisposedException(nameof(ALSoundController));
        ...
        public static void EnsureInitialized()
        {
            ...
            try
            {
                _instance = new ALSoundController();
            }
