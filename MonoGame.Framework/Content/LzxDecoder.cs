...
namespace MonoGame.Framework.Content
{
    ...
    class LzxDecoder
    {
        ...
        public LzxDecoder(int window)
        {
            ...
            if (window < 15 || window > 21)
                throw new UnsupportedWindowSizeException(nameof(window));
        ...
        private struct BitBuffer
        {
            ...
            public BitBuffer(Stream stream) : this()
            {
                byteStream = stream;
                InitBitStream();
            }
    ...
    class UnsupportedWindowSizeException : ArgumentOutOfRangeException
    {
        public UnsupportedWindowSizeException()
        {
        }

        public UnsupportedWindowSizeException(string paramName) : base(paramName)
        {
        }
    }
}