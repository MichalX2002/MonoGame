...
namespace MonoGame.Framework.Graphics
{
    public class Effect : GraphicsResource
    {
        ...
        /// </summary>
        /// <remarks>
        /// Note this is not overloaded in derived classes on purpose.  
        /// This is only a reason this exists is for caching effects.
        /// </remarks>
        ...
        private void ReadEffect(BinaryReader reader)
        {
            ...
            for (var c = 0; c < buffers; c++)
            {
                ...
                ConstantBuffers[c] = new ConstantBuffer(
                    GraphicsDevice, sizeInBytes, parameters, offsets, name);
            }
                ...
                if (elements.Count == 0 && structMembers.Count == 0)
                {
                    switch (type)
                    {
                        ...
                        case EffectParameterType.String:
                            ...
                            // type should do in the parameter list.  
                            // Till then throw to let the user know.
                            throw new NotSupportedException(
                                "Effect parameter of type string is not supported.");
