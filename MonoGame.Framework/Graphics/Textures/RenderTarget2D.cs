...
namespace MonoGame.Framework.Graphics
{
    public partial class RenderTarget2D : Texture2D, IRenderTarget
    {
        ...
        public RenderTarget2D(
            ...
            int preferredMultiSampleCount, RenderTargetUsage usage, bool shared, int arraySize) :
            base(
        ...
        public RenderTarget2D(
            ...
            this(
                graphicsDevice, width, height, mipMap,
                preferredFormat, preferredDepthFormat,
                preferredMultiSampleCount, usage, false)
        {
        }
        ...
        protected RenderTarget2D(GraphicsDevice graphicsDevice,
            ...
            RenderTargetUsage usage, SurfaceType surfaceType) :
