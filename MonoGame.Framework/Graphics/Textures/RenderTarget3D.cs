...
namespace MonoGame.Framework.Graphics
{
    public partial class RenderTarget3D : Texture3D, IRenderTarget
    {
        ...
        public RenderTarget3D(
            ...
            : base (
                  graphicsDevice, width, height, depth, mipMap, 
                  QuerySelectedFormat(graphicsDevice, preferredFormat), true)
        {
            ...
            PlatformConstruct(
                graphicsDevice, width, height, mipMap, preferredDepthFormat, preferredMultiSampleCount, usage);
        }

        protected static SurfaceFormat QuerySelectedFormat(
            GraphicsDevice graphicsDevice, SurfaceFormat preferredFormat)
        {
            ...
            if (graphicsDevice != null)
            {
                graphicsDevice.Adapter.QueryRenderTargetFormat(
                    graphicsDevice.GraphicsProfile, preferredFormat, DepthFormat.None, 0,
        ...
        public RenderTarget3D(
            ...
            : this(
                  graphicsDevice, width, height, depth, false,
