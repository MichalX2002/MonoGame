...
namespace MonoGame.Framework.Graphics
{
    ...
    public partial class RenderTargetCube : TextureCube, IRenderTarget
    {
        ...
        public event SimpleEventHandler<RenderTargetCube> ContentLost;
        ...
        public RenderTargetCube(
            GraphicsDevice graphicsDevice, int size, bool mipMap, SurfaceFormat preferredFormat, DepthFormat preferredDepthFormat, int preferredMultiSampleCount, RenderTargetUsage usage)
