...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    {
        private readonly Dictionary<int, VertexDeclarationAttributeInfo> _shaderAttributeInfo = new Dictionary<int, VertexDeclarationAttributeInfo>(new Int32Comparer());
