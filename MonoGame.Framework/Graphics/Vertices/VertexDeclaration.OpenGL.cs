...
namespace Microsoft.Xna.Framework.Graphics
{
    ...
    {
        private readonly Dictionary<int, VertexDeclarationAttributeInfo> _shaderAttributeInfo = new Dictionary<int, VertexDeclarationAttributeInfo>(Int32Comparer.Instance);
