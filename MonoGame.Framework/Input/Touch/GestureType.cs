...
{
    /// <summary>
    /// Enumuration of values that represent different gestures 
    /// that can be processed by <see cref="TouchPanel.ReadGesture"/>.
    /// </summary>
	[Flags]
    public enum GestureType
    {
        ...
        /// <summary>
        /// States completion of a drag gesture 
        /// (<see cref="VerticalDrag"/>, <see cref="HorizontalDrag"/>, or <see cref="FreeDrag"/>).
        /// </summary>
	    ...
	    /// </summary>    
	    /// <remarks>
        /// Flicks does not contain position information. 
        /// The velocity of it can be read from <see cref="GestureSample.Delta1"/></remarks>
        Flick = 4,
        ...
        /// </summary>
        /// <remarks>
        /// As this is a single event, 
        /// it will not be continuously fired while the user is holding the touch-point.
        /// </remarks>
        Hold = 16,
        ...
        /// </summary>
        /// <remarks>
        /// When this gesture-type is enabled and two fingers are down,
        /// it takes precedence over drag gestures.
        /// </remarks>
        Pinch = 64,
        ...
        /// </summary>
        /// <remarks>
        /// If the time between two touchs are long enough,
        /// insted two seperate single Tap gestures will be generated.
        /// </remarks>
        DoubleTap = 256,
