...
namespace MonoGame.Framework
{
    ...
    public static class AndroidCompatibility
    {
        ...
        /// This list contains all the <see cref="Build.Model"/> strings of the effected devices,
        /// it should be added to if and when more devices exhibit the same issues.
        /// </summary>
        private static readonly string[] Kindles = new[]
        {
            "KFTT", "KFJWI", "KFJWA", "KFSOWI", "KFTHWA", "KFTHWI", "KFAPWA", "KFAPWI"
        };
        ...
        {
            var orientation = AndroidGameActivity.Instance.Resources.Configuration.Orientation;
            SurfaceOrientation rotation = AndroidGameActivity.Instance.WindowManager.DefaultDisplay.Rotation;
        ...
        internal static DisplayOrientation GetAbsoluteOrientation(int orientation)
        {
            ...
            DisplayOrientation disporientation;
            switch (ort)
            {
                case 90:
        ...
        {
            var orientation = AndroidGameActivity.Instance.WindowManager.DefaultDisplay.Rotation;
