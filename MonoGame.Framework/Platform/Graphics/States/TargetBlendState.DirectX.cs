...
namespace MonoGame.Framework.Graphics
{
    public partial class TargetBlendState
    {
        ...
        static private SharpDX.Direct3D11.BlendOption GetBlendOption(Blend blend, bool alpha)
        {
            switch (blend)
            {
                ...
                case Blend.DestinationColor:
                    return alpha
                        ? SharpDX.Direct3D11.BlendOption.DestinationAlpha
                ...
                case Blend.InverseDestinationColor:
                    return alpha
                        ? SharpDX.Direct3D11.BlendOption.InverseDestinationAlpha
                ...
                case Blend.SourceColor:
                    return alpha
                        ? SharpDX.Direct3D11.BlendOption.SourceAlpha
        ...
        {
            return
                ((mask & ColorWriteChannels.Red) != 0 ? SharpDX.Direct3D11.ColorWriteMaskFlags.Red : 0) |
