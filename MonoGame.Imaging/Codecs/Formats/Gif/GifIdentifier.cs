...
namespace MonoGame.Imaging.Codecs.Identification
{/*
    public class GifIdentifier : StbIdentifierBase
    {
        ...
        public override int HeaderSize =>
            throw new NotImplementedException();//Gif.HeaderSize;
        ...
        protected override bool GetInfo(
            ImagingConfig config, BinReader reader, out ReadState readState)
        {
            throw new NotImplementedException();
            //return Gif.Info(reader, out readState);
        }
    }*/
}
