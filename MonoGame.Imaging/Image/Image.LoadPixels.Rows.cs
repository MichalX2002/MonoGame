...
namespace MonoGame.Imaging
{
    ...
    {
        private static void LoadPixelRowsCore<TPixelFrom, TPixelTo>(
        ...
        {
            LoadPixelRows<TPixelFrom, TPixelTo>(pixels, sourceRectangle, destination);
        }

        public static void LoadPixelRows<TPixelFrom, TPixelTo>(
            IReadOnlyPixelRows pixels, Rectangle sourceRectangle, Image<TPixelTo> destination)
            where TPixelFrom : unmanaged, IPixel
            where TPixelTo : unmanaged, IPixel
        {
