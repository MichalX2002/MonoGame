...
namespace MonoGame.Imaging
{
    ...
    /// </summary>
    public class LayerCollection<TPixel> : ImageCollection<TPixel, ImageFrame<TPixel>>,
        ...
        where TPixel : unmanaged, IPixel
    {
        ...
        /// </summary>
        public LayerCollection(int capacity) : base(null, capacity)
        {
        }
        ...
        public LayerCollection(IEnumerable<ImageFrame<TPixel>> frames) : this()
        {
            if (frames != null)
        ...
        public LayerCollection(IEnumerable<IReadOnlyPixelBuffer<TPixel>> images, int delay) :
        ...
        public LayerCollection(Image<TPixel> image) : this(1)
        {
