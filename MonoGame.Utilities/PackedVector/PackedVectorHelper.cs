...
namespace MonoGame.Framework.PackedVector
{
    public static class PackedVectorHelper
    {
        ...
        public static byte DownScale16To8Bit(ushort component) => (byte)(((component * 255) + 32895) >> 16);
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte DownScale32To8Bit(uint component) => (byte)(component / (double)uint.MaxValue * byte.MaxValue);
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint UpScale8To32Bit(byte component) => (uint)(component / (double)byte.MaxValue * uint.MaxValue);
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static uint UpScale16To32Bit(ushort component) => (uint)(component / (double)ushort.MaxValue * uint.MaxValue);
