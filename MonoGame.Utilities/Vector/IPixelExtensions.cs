...
namespace MonoGame.Framework.Vectors
{
    ...
    public static class IPixelExtensions
    {
        ...
        public static void FromAlpha<T>(this ref T destination, Alpha8 source)
            where T : struct, IPixel
        {
            destination.FromAlpha(source);
        }

        public static void FromAlpha<T>(this ref T destination, Alpha16 source)
            where T : struct, IPixel
        {
            destination.FromAlpha(source);
        }

        public static void FromAlpha<T>(this ref T destination, AlphaF source)
            where T : struct, IPixel
        {
            destination.FromAlpha(source);
        }
        ...
        public static Color ToRgba32<T>(this T pixel)
            where T : IPixel
        {
            return pixel.ToRgba32();
        }
        */
    }
}
