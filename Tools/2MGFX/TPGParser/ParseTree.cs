...
namespace TwoMGFX.TPGParser
{
    ...
    public partial class ParseNode
    {
        ...
        public string Text { get; set; } // text to display in parse tree 
        ...
        {
            return GetValueWithRef(tree, type, ref index);
        }

        protected object GetValueWithRef(ParseTree tree, TokenType type, ref int index)
        {
            object o = null;
            if (index < 0)
                return o;
        ...
        protected virtual object EvalFillMode_Solid(ParseTree tree, params object[] paramlist) => FillMode.Solid;

        protected virtual object EvalFillMode_WireFrame(ParseTree tree, params object[] paramlist) => FillMode.WireFrame;
        ...
        protected virtual object EvalCullMode_None(ParseTree tree, params object[] paramlist) => CullMode.None;

        protected virtual object EvalCullMode_Cw(ParseTree tree, params object[] paramlist) => CullMode.CullClockwiseFace;

        protected virtual object EvalCullMode_Ccw(ParseTree tree, params object[] paramlist) => CullMode.CullCounterClockwiseFace;
        ...
        protected virtual object EvalColors_None(ParseTree tree, params object[] paramlist) => ColorWriteChannels.None;

        protected virtual object EvalColors_Red(ParseTree tree, params object[] paramlist) => ColorWriteChannels.Red;

        protected virtual object EvalColors_Green(ParseTree tree, params object[] paramlist) => ColorWriteChannels.Green;

        protected virtual object EvalColors_Blue(ParseTree tree, params object[] paramlist) => ColorWriteChannels.Blue;

        protected virtual object EvalColors_Alpha(ParseTree tree, params object[] paramlist) => ColorWriteChannels.Alpha;

        protected virtual object EvalColors_All(ParseTree tree, params object[] paramlist) => ColorWriteChannels.All;
        ...
        protected virtual object EvalBlend_Zero(ParseTree tree, params object[] paramlist) => Blend.Zero;

        protected virtual object EvalBlend_One(ParseTree tree, params object[] paramlist) => Blend.One;

        protected virtual object EvalBlend_SrcColor(ParseTree tree, params object[] paramlist) => Blend.SourceColor;

        protected virtual object EvalBlend_InvSrcColor(ParseTree tree, params object[] paramlist) => Blend.InverseSourceColor;

        protected virtual object EvalBlend_SrcAlpha(ParseTree tree, params object[] paramlist) => Blend.SourceAlpha;

        protected virtual object EvalBlend_InvSrcAlpha(ParseTree tree, params object[] paramlist) => Blend.InverseSourceAlpha;

        protected virtual object EvalBlend_DestAlpha(ParseTree tree, params object[] paramlist) => Blend.DestinationAlpha;

        protected virtual object EvalBlend_InvDestAlpha(ParseTree tree, params object[] paramlist) => Blend.InverseDestinationAlpha;

        protected virtual object EvalBlend_DestColor(ParseTree tree, params object[] paramlist) => Blend.DestinationColor;

        protected virtual object EvalBlend_InvDestColor(ParseTree tree, params object[] paramlist) => Blend.InverseDestinationColor;

        protected virtual object EvalBlend_SrcAlphaSat(ParseTree tree, params object[] paramlist) => Blend.SourceAlphaSaturation;

        protected virtual object EvalBlend_BlendFactor(ParseTree tree, params object[] paramlist) => Blend.BlendFactor;

        protected virtual object EvalBlend_InvBlendFactor(ParseTree tree, params object[] paramlist) => Blend.InverseBlendFactor;

        protected virtual object EvalBlends(ParseTree tree, params object[] paramlist)
        {
            return GetValue(tree, TokenType.Blend_Zero, 0) ?? GetValue(tree, TokenType.Blend_One, 0) ?? GetValue(tree, TokenType.Blend_SrcColor, 0) ?? GetValue(tree, TokenType.Blend_InvSrcColor, 0) ?? GetValue(tree, TokenType.Blend_SrcAlpha, 0) ?? GetValue(tree, TokenType.Blend_InvSrcAlpha, 0) ??
                    GetValue(tree, TokenType.Blend_DestAlpha, 0) ?? GetValue(tree, TokenType.Blend_InvDestAlpha, 0) ?? GetValue(tree, TokenType.Blend_DestColor, 0) ?? GetValue(tree, TokenType.Blend_InvDestColor, 0) ?? GetValue(tree, TokenType.Blend_SrcAlphaSat, 0) ??
                    GetValue(tree, TokenType.Blend_BlendFactor, 0) ?? GetValue(tree, TokenType.Blend_InvBlendFactor, 0);
        }

        protected virtual object EvalBlendOp_Add(ParseTree tree, params object[] paramlist) => BlendFunction.Add;

        protected virtual object EvalBlendOp_Subtract(ParseTree tree, params object[] paramlist) => BlendFunction.Subtract;

        protected virtual object EvalBlendOp_RevSubtract(ParseTree tree, params object[] paramlist) => BlendFunction.ReverseSubtract;

        protected virtual object EvalBlendOp_Min(ParseTree tree, params object[] paramlist) => BlendFunction.Min;

        protected virtual object EvalBlendOp_Max(ParseTree tree, params object[] paramlist) => BlendFunction.Max;
        ...
        protected virtual object EvalCmpFunc_Never(ParseTree tree, params object[] paramlist) => CompareFunction.Never;

        protected virtual object EvalCmpFunc_Less(ParseTree tree, params object[] paramlist) => CompareFunction.Less;

        protected virtual object EvalCmpFunc_Equal(ParseTree tree, params object[] paramlist) => CompareFunction.Equal;

        protected virtual object EvalCmpFunc_LessEqual(ParseTree tree, params object[] paramlist) => CompareFunction.LessEqual;

        protected virtual object EvalCmpFunc_Greater(ParseTree tree, params object[] paramlist) => CompareFunction.Greater;

        protected virtual object EvalCmpFunc_NotEqual(ParseTree tree, params object[] paramlist) => CompareFunction.NotEqual;

        protected virtual object EvalCmpFunc_GreaterEqual(ParseTree tree, params object[] paramlist) => CompareFunction.GreaterEqual;

        protected virtual object EvalCmpFunc_Always(ParseTree tree, params object[] paramlist) => CompareFunction.Always;
        ...
        protected virtual object EvalStencilOp_Keep(ParseTree tree, params object[] paramlist) => StencilOperation.Keep;

        protected virtual object EvalStencilOp_Zero(ParseTree tree, params object[] paramlist) => StencilOperation.Zero;

        protected virtual object EvalStencilOp_Replace(ParseTree tree, params object[] paramlist) => StencilOperation.Replace;

        protected virtual object EvalStencilOp_IncrSat(ParseTree tree, params object[] paramlist) => StencilOperation.IncrementSaturation;

        protected virtual object EvalStencilOp_DecrSat(ParseTree tree, params object[] paramlist) => StencilOperation.DecrementSaturation;

        protected virtual object EvalStencilOp_Invert(ParseTree tree, params object[] paramlist) => StencilOperation.Invert;

        protected virtual object EvalStencilOp_Incr(ParseTree tree, params object[] paramlist) => StencilOperation.Increment;

        protected virtual object EvalStencilOp_Decr(ParseTree tree, params object[] paramlist) => StencilOperation.Decrement;
        ...
        {
            (paramlist[0] as PassInfo).CullMode = (CullMode)GetValue(tree, TokenType.CullModes, 0); return null;
        }

        protected virtual object EvalRender_State_FillMode(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).FillMode = (FillMode)GetValue(tree, TokenType.FillModes, 0); return null;
        }

        protected virtual object EvalRender_State_AlphaBlendEnable(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).AlphaBlendEnable = ParseTreeTools.ParseBool((string)GetValue(tree, TokenType.Boolean, 0)); return null;
        }

        protected virtual object EvalRender_State_SrcBlend(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).SrcBlend = (Blend)GetValue(tree, TokenType.Blends, 0); return null;
        }

        protected virtual object EvalRender_State_DestBlend(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).DestBlend = (Blend)GetValue(tree, TokenType.Blends, 0); return null;
        }

        protected virtual object EvalRender_State_BlendOp(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).BlendOp = (BlendFunction)GetValue(tree, TokenType.BlendOps, 0); return null;
        }

        protected virtual object EvalRender_State_ColorWriteEnable(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).ColorWriteEnable = (ColorWriteChannels)GetValue(tree, TokenType.ColorsMasks, 0); return null;
        }

        protected virtual object EvalRender_State_DepthBias(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).DepthBias = ParseTreeTools.ParseFloat((string)GetValue(tree, TokenType.Number, 0)); return null;
        }

        protected virtual object EvalRender_State_SlopeScaleDepthBias(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).SlopeScaleDepthBias = ParseTreeTools.ParseFloat((string)GetValue(tree, TokenType.Number, 0)); return null;
        }

        protected virtual object EvalRender_State_ZEnable(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).ZEnable = ParseTreeTools.ParseBool((string)GetValue(tree, TokenType.Boolean, 0)); return null;
        }

        protected virtual object EvalRender_State_ZWriteEnable(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).ZWriteEnable = ParseTreeTools.ParseBool((string)GetValue(tree, TokenType.Boolean, 0)); return null;
        }

        protected virtual object EvalRender_State_ZFunc(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).DepthBufferFunction = (CompareFunction)GetValue(tree, TokenType.CmpFunc, 0); return null;
        }

        protected virtual object EvalRender_State_MultiSampleAntiAlias(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).MultiSampleAntiAlias = ParseTreeTools.ParseBool((string)GetValue(tree, TokenType.Boolean, 0)); return null;
        }

        protected virtual object EvalRender_State_ScissorTestEnable(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).ScissorTestEnable = ParseTreeTools.ParseBool((string)GetValue(tree, TokenType.Boolean, 0)); return null;
        }

        protected virtual object EvalRender_State_StencilEnable(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilEnable = ParseTreeTools.ParseBool((string)GetValue(tree, TokenType.Boolean, 0)); return null;
        }

        protected virtual object EvalRender_State_StencilFail(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilFail = (StencilOperation)GetValue(tree, TokenType.StencilOp, 0); return null;
        }

        protected virtual object EvalRender_State_StencilFunc(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilFunc = (CompareFunction)GetValue(tree, TokenType.CmpFunc, 0); return null;
        }

        protected virtual object EvalRender_State_StencilMask(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilMask = ParseTreeTools.ParseInt((string)GetValue(tree, TokenType.Number, 0)); return null;
        }

        protected virtual object EvalRender_State_StencilPass(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilPass = (StencilOperation)GetValue(tree, TokenType.StencilOp, 0); return null;
        }

        protected virtual object EvalRender_State_StencilRef(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilRef = ParseTreeTools.ParseInt((string)GetValue(tree, TokenType.Number, 0)); return null;
        }

        protected virtual object EvalRender_State_StencilWriteMask(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilWriteMask = ParseTreeTools.ParseInt((string)GetValue(tree, TokenType.Number, 0)); return null;
        }

        protected virtual object EvalRender_State_StencilZFail(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as PassInfo).StencilZFail = (StencilOperation)GetValue(tree, TokenType.StencilOp, 0); return null;
        }
        ...
        protected virtual object EvalAddressMode_Clamp(ParseTree tree, params object[] paramlist) => TextureAddressMode.Clamp;

        protected virtual object EvalAddressMode_Wrap(ParseTree tree, params object[] paramlist) => TextureAddressMode.Wrap;

        protected virtual object EvalAddressMode_Mirror(ParseTree tree, params object[] paramlist) => TextureAddressMode.Mirror;

        protected virtual object EvalAddressMode_Border(ParseTree tree, params object[] paramlist) => TextureAddressMode.Border;
        ...
        protected virtual object EvalTextureFilter_None(ParseTree tree, params object[] paramlist) => TextureFilterType.None;

        protected virtual object EvalTextureFilter_Linear(ParseTree tree, params object[] paramlist) => TextureFilterType.Linear;

        protected virtual object EvalTextureFilter_Point(ParseTree tree, params object[] paramlist) => TextureFilterType.Point;

        protected virtual object EvalTextureFilter_Anisotropic(ParseTree tree, params object[] paramlist) => TextureFilterType.Anisotropic;
        ...
        {
            (paramlist[0] as SamplerStateInfo).TextureName = (string)GetValue(tree, TokenType.Identifier, 0); return null;
        }

        protected virtual object EvalSampler_State_MinFilter(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).MinFilter = (TextureFilterType)GetValue(tree, TokenType.TextureFilter, 0); return null;
        }

        protected virtual object EvalSampler_State_MagFilter(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).MagFilter = (TextureFilterType)GetValue(tree, TokenType.TextureFilter, 0); return null;
        }

        protected virtual object EvalSampler_State_MipFilter(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).MipFilter = (TextureFilterType)GetValue(tree, TokenType.TextureFilter, 0); return null;
        }

        protected virtual object EvalSampler_State_Filter(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).Filter = (TextureFilterType)GetValue(tree, TokenType.TextureFilter, 0); return null;
        }

        protected virtual object EvalSampler_State_AddressU(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).AddressU = (TextureAddressMode)GetValue(tree, TokenType.AddressMode, 0); return null;
        }

        protected virtual object EvalSampler_State_AddressV(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).AddressV = (TextureAddressMode)GetValue(tree, TokenType.AddressMode, 0); return null;
        }

        protected virtual object EvalSampler_State_AddressW(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).AddressW = (TextureAddressMode)GetValue(tree, TokenType.AddressMode, 0); return null;
        }

        protected virtual object EvalSampler_State_BorderColor(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).BorderColor = ParseTreeTools.ParseColor((string)GetValue(tree, TokenType.HexColor, 0)); return null;
        }

        protected virtual object EvalSampler_State_MaxMipLevel(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).MaxMipLevel = ParseTreeTools.ParseInt((string)GetValue(tree, TokenType.Number, 0)); return null;
        }

        protected virtual object EvalSampler_State_MaxAnisotropy(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).MaxAnisotropy = ParseTreeTools.ParseInt((string)GetValue(tree, TokenType.Number, 0)); return null;
        }

        protected virtual object EvalSampler_State_MipLodBias(ParseTree tree, params object[] paramlist)
        {
            (paramlist[0] as SamplerStateInfo).MipMapLevelOfDetailBias = ParseTreeTools.ParseFloat((string)GetValue(tree, TokenType.Number, 0)); return null;
        }
        ...
        protected virtual object EvalSampler_Declaration(ParseTree tree, params object[] paramlist)
        {
            ...
            if (GetValue(tree, TokenType.Semicolon, 0) == null) return null;
